...
namespace model_gPFA_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gPFA");
    reader.add_event(37, 35, "end", "model_gPFA");
    return reader;
}
#include <stan_meta_header.hpp>
class model_gPFA : public prob_grad {
private:
        int n;
        int m;
        int p;
...
public:
    model_gPFA(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gPFA_namespace::model_gPFA";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                lp_accum__.add(poisson_log<propto__>(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), "X"), multiply(Psi, stan::model::rvalue(Theta, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(get_base1(g, i, "g", 1)), stan::model::nil_index_list())), "Theta"))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gPFA_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gPFA_namespace::model_gPFA stan_model;
#endif
