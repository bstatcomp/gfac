...
namespace model_gGPFA_LP_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gGPFA_LP");
    reader.add_event(112, 110, "end", "model_gGPFA_LP");
    return reader;
}
...
class model_gGPFA_LP : public prob_grad {
private:
        int N;
        int NG;
        int M;
        ...
        double sq_sigma;
public:
    model_gGPFA_LP(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gGPFA_LP_namespace::model_gGPFA_LP";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("sigma", "M", M);
        context__.validate_dims("parameter initialization", "sigma", "vector_d", context__.to_vec(M));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int m = 1; m <= M; ++m) {
                ...
                lp_accum__.add(student_t_log<propto__>(get_base1(sigma, m, "sigma", 1), 3, 0, 1));
                current_statement_begin__ = 107;
                lp_accum__.add(normal_log<propto__>(get_base1(X, m, "X", 1), get_base1(mu_fac, m, "mu_fac", 1), get_base1(sigma, m, "sigma", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gGPFA_LP_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> sigma = in__.vector_lb_constrain(0, M);
        size_t sigma_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < sigma_j_1_max__; ++j_1__) {
...
typedef model_gGPFA_LP_namespace::model_gGPFA_LP stan_model;
#endif
