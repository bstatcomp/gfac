...
namespace model_gNBGPR_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gNBGPR");
    reader.add_event(106, 104, "end", "model_gNBGPR");
    return reader;
}
...
class model_gNBGPR : public prob_grad {
private:
        int N;
        int NG;
        int M;
        ...
        matrix_d Psi;
public:
    model_gNBGPR(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gNBGPR_namespace::model_gNBGPR";
        ...
        try {
            ...
            validate_non_negative_index("Psi", "M", M);
            Psi = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(M, M);
            stan::math::fill(Psi, DUMMY_VAR__);
            stan::math::assign(Psi,diag_matrix(rep_vector(1, M)));
            ...
            validate_non_negative_index("fn_pri", "M", M);
            ...
            validate_non_negative_index("a2", "M", M);
            validate_non_negative_index("a2", "NG", NG);
            num_params_r__ += (M * NG);
            current_statement_begin__ = 48;
            validate_non_negative_index("r2", "M", M);
            validate_non_negative_index("r2", "NG", NG);
            num_params_r__ += (M * NG);
            current_statement_begin__ = 49;
            validate_non_negative_index("r3", "M", M);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("fn_pri", "M", M);
        validate_non_negative_index("fn_pri", "N", N);
        context__.validate_dims("parameter initialization", "fn_pri", "matrix_d", context__.to_vec(M,N));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> fn_pri(M, N);
        size_t fn_pri_j_2_max__ = N;
        size_t fn_pri_j_1_max__ = M;
        ...
        validate_non_negative_index("a2", "M", M);
        validate_non_negative_index("a2", "NG", NG);
        context__.validate_dims("parameter initialization", "a2", "vector_d", context__.to_vec(NG,M));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > a2(NG, Eigen::Matrix<double, Eigen::Dynamic, 1>(M));
        size_t a2_j_1_max__ = M;
        ...
        validate_non_negative_index("r2", "M", M);
        validate_non_negative_index("r2", "NG", NG);
        context__.validate_dims("parameter initialization", "r2", "vector_d", context__.to_vec(NG,M));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > r2(NG, Eigen::Matrix<double, Eigen::Dynamic, 1>(M));
        size_t r2_j_1_max__ = M;
        ...
        validate_non_negative_index("r3", "M", M);
        validate_non_negative_index("r3", "NG", NG);
        context__.validate_dims("parameter initialization", "r3", "vector_d", context__.to_vec(NG,M));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > r3(NG, Eigen::Matrix<double, Eigen::Dynamic, 1>(M));
        size_t r3_j_1_max__ = M;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                fn_pri = in__.matrix_constrain(M, N, lp__);
            else
                fn_pri = in__.matrix_constrain(M, N);
            current_statement_begin__ = 45;
            ...
            for (size_t d_0__ = 0; d_0__ < a2_d_0_max__; ++d_0__) {
                if (jacobian__)
                    a2.push_back(in__.vector_lb_constrain(0, M, lp__));
                else
                    a2.push_back(in__.vector_lb_constrain(0, M));
            }
            current_statement_begin__ = 48;
            ...
            for (size_t d_0__ = 0; d_0__ < r2_d_0_max__; ++d_0__) {
                if (jacobian__)
                    r2.push_back(in__.vector_lb_constrain(0, M, lp__));
                else
                    r2.push_back(in__.vector_lb_constrain(0, M));
            }
            current_statement_begin__ = 49;
            ...
            for (size_t d_0__ = 0; d_0__ < r3_d_0_max__; ++d_0__) {
                if (jacobian__)
                    r3.push_back(in__.vector_lb_constrain(0, M, lp__));
                else
                    r3.push_back(in__.vector_lb_constrain(0, M));
            }
            current_statement_begin__ = 51;
            ...
            validate_non_negative_index("fn", "M", M);
            validate_non_negative_index("fn", "N", N);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> fn(M, N);
            ...
            for (int m = 1; m <= M; ++m) {
                ...
                lp_accum__.add(neg_binomial_2_log<propto__>(get_base1(X, m, "X", 1), get_base1(mu_fac, m, "mu_fac", 1), get_base1(phi, m, "phi", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gNBGPR_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> fn_pri = in__.matrix_constrain(M, N);
        size_t fn_pri_j_2_max__ = N;
        size_t fn_pri_j_1_max__ = M;
        for (size_t j_2__ = 0; j_2__ < fn_pri_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < fn_pri_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("fn", "M", M);
            validate_non_negative_index("fn", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> fn(M, N);
            stan::math::initialize(fn, DUMMY_VAR__);
            stan::math::fill(fn, DUMMY_VAR__);
...
typedef model_gNBGPR_namespace::model_gNBGPR stan_model;
#endif
