...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FA");
    reader.add_event(59, 57, "end", "model_FA");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FA : public prob_grad {
private:
        int n;
        int m;
        int p;
        ...
        matrix_d X;
public:
    model_FA(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_FA_namespace::model_FA";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "g", "vector_d", context__.to_vec(n));
            g = Eigen::Matrix<double, Eigen::Dynamic, 1>(n);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 12;
        if (!(context__.contains_r("Factor")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable Factor missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("Factor");
        pos__ = 0U;
        validate_non_negative_index("Factor", "p", p);
        validate_non_negative_index("Factor", "n", n);
        context__.validate_dims("parameter initialization", "Factor", "matrix_d", context__.to_vec(p,n));
        ...
        for (size_t j_2__ = 0; j_2__ < Factor_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < Factor_j_1_max__; ++j_1__) {
                Factor(j_1__, j_2__) = vals_r__[pos__++];
            }
        }
        try {
            writer__.matrix_unconstrain(Factor);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable Factor: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 13;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 12;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> Factor;
            (void) Factor;  // dummy to suppress unused var warning
            if (jacobian__)
                Factor = in__.matrix_constrain(p, n, lp__);
            else
                Factor = in__.matrix_constrain(p, n);
            current_statement_begin__ = 13;
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                for (int j = 1; j <= p; ++j) {
                    ...
                    lp_accum__.add(normal_log<propto__>(get_base1(Factor, j, i, "Factor", 1), 0, fac_var));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_FA_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> Factor = in__.matrix_constrain(p, n);
        size_t Factor_j_2_max__ = n;
        size_t Factor_j_1_max__ = p;
        for (size_t j_2__ = 0; j_2__ < Factor_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < Factor_j_1_max__; ++j_1__) {
...
typedef model_FA_namespace::model_FA stan_model;
#endif
