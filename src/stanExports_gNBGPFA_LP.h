...
namespace model_gNBGPFA_LP_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gNBGPFA_LP");
    reader.add_event(117, 115, "end", "model_gNBGPFA_LP");
    return reader;
}
...
class model_gNBGPFA_LP : public prob_grad {
private:
        int N;
        int NG;
        int M;
        ...
        double sq_sigma;
public:
    model_gNBGPFA_LP(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gNBGPFA_LP_namespace::model_gNBGPFA_LP";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gNBGPFA_LP_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gNBGPFA_LP_namespace::model_gNBGPFA_LP stan_model;
#endif
