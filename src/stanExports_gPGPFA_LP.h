...
namespace model_gPGPFA_LP_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gPGPFA_LP");
    reader.add_event(110, 108, "end", "model_gPGPFA_LP");
    return reader;
}
...
class model_gPGPFA_LP : public prob_grad {
private:
        int N;
        int NG;
        int M;
        ...
        double sq_sigma;
public:
    model_gPGPFA_LP(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gPGPFA_LP_namespace::model_gPGPFA_LP";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int m = 1; m <= M; ++m) {
                ...
                lp_accum__.add(poisson_log<propto__>(get_base1(X, m, "X", 1), get_base1(mu_fac, m, "mu_fac", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gPGPFA_LP_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gPGPFA_LP_namespace::model_gPGPFA_LP stan_model;
#endif
