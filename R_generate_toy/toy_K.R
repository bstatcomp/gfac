...
F2 <- draw_samples(x, 1, seed = 10, lp_kernel, alpha2 = 5, rho2 = 3, rho3 = 7 * 2)
F4 <- draw_samples(x, 1, seed = 42, se_kernel, alpha1 = 5, rho1 = 3 * 2)
F5 <- draw_samples(x, 1, seed = 27, lp_kernel, alpha2 = 5, rho2 = 4, rho3 = 8 * 2)
...
F_mat <- as.matrix(data.frame(D1 = c(F1, F4), D2 = c(F2 * 10, F5 * 10)))
...
# ggsave("./data_clean/plots/toy_I4.pdf", width = 16, height = 14)
...
save(data_out, file = "./data/toy_K.RData")
