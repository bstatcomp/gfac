...
F2 <- draw_samples(x, 1, seed = 10, lp_kernel, alpha2 = 2, rho2 = 4, rho3 = 7 * 2)
F4 <- draw_samples(x, 1, seed = 42, se_kernel, alpha1 = 2, rho1 = 3  * 2)
F5 <- draw_samples(x, 1, seed = 23, lp_kernel, alpha2 = 2, rho2 = 3, rho3 = 8 * 2)
