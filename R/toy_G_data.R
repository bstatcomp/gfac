#' toy G data
#'
#' A generated data set with moderate overdispersed counts (rounded normal), temporal latent 2-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_G
