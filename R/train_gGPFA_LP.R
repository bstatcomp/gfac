#' Train a Gaussian process factor analysis model
#'
#' This function trains a Gaussian process factor analysis model with a locally periodic kernel in Stan. Uses a normal likelihood and standardized data.
#'
#' @export
...
train_gGPFA_LP <- function (X, ts, gp, nfac, nit, nchain, period_length,
                              prior_r2, prior_r3,
