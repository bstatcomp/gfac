#' toy F data
#'
#' A generated data set with moderate non-overdispersed counts (rounded normal), temporal latent 2-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_F
#' @format A list with four elements.
#'   \describe{
#'     \item{df}{A data frame with 400 rows and 9 columns.}
