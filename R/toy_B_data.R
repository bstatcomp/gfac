#' toy B data
#'
#' A generated data set with moderate overdispersed counts (negative binomial), temporal latent 3-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_B
