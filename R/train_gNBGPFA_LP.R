#' Train a negative binomial Gaussian process factor analysis model
#'
#' This function trains a negative binomial Gaussian process factor analysis model with a locally periodic kernel in Stan.
#'
#' @export
...
train_gNBGPFA_LP <- function (X, ts, gp, nfac, nit, nchain, period_length,
