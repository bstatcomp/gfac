#' toy L data
#'
#' A generated data set with moderate non-overdispersed counts (rounded negatively-skewed normal), temporal latent 2-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_L
