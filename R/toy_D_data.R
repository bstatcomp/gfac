#' toy D data
#'
#' A generated data set with moderate non-overdispersed counts (Poisson), temporal latent 3-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_D
