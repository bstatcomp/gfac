#' toy I data
#'
#' A generated data set with moderate non-overdispersed counts (rounded positively-skewed normal), temporal latent 2-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_I
