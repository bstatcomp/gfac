#' toy H data
#'
#' A generated data set with low non-overdispersed counts (rounded normal), temporal latent 2-factor structure, and residual covariance not due to the latent structure.
#'
#' @name toy_H
